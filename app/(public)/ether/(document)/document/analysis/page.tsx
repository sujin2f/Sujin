    ...
    useEffect(() => {
        ...
        dispatch(
            setBanner({
                ...
                excerpt: 'Comparison with Actual Values',
                icon: undefined,
                prefix: undefined,
    ...
    return (
        <>
            ...
            <div className="align__center">
                <Image src={pic96} alt="Changes in the Helium Orbital Values" />
                <p>
            ...
            <div className="align__center">
                <Image src={pic98} alt="Circle comes first!" />
                <p>
            ...
            <div className="align__center">
                <BlockMath>{`D(x) = v_2 - v_1 - (R(x+1+k_{2}) - R(x+k_{1}))`}</BlockMath>
                ...
                <BlockMath>{`D(x) = \\dfrac{v_2 - v_1 - (R(x+1+k_{2}) - R(x+k_{1}))}{R(x+1+k_{2}) - R(x+k_{1})} `}</BlockMath>
                <p>
                    The result D(x), where weights are applied to make it easier
                    to see as you go backward
                </p>
            </div>
            ...
            <Table scroll center caption="Values of the One Circular Ether">
                <thead>
                    <tr>
                        <th></th>
                        <th>H</th>
            ...
            <div className="align__center">
                <Image src={pic29} alt="How Many Times of 0.75?" />
                <p>
            ...
            <div className="align__center">
                <Image src={pic42} alt="Prediction of Vertical Shifts" />
                <p>
            ...
            <div className="align__center">
                <p>
                    ...
                    beryllium, one must understand the rules of the
