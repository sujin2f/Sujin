    ...
    return (
        <>
            ...
            <div className="align__center">
                <Image src={pic9} alt="Electron Orbital" />
                <p>
            ...
            <div className="align__center">
                <Image src={pic56} alt="Helium's s and p Orbitals" />
                <p>
            ...
            <div className="align__center">
                <BlockMath>{` R^{1.1}(x) = 13.60676328 \\cdot (1 - \\dfrac{1}{(x + 1)^2}) `}</BlockMath>
                <p>Rydberg formula of hydrogen (eV)</p>
                <BlockMath>{`R^{2.1}(x) = 13.60676328 \\cdot (1 - \\dfrac{1}{(x + 1)^2}) + 24.58556828 - 13.60676328`}</BlockMath>
            ...
            <div className="align__center">
                <BlockMath>{`w = r \\cdot (1 - \\dfrac{1}{(v + 1 + k)^2}) + s`}</BlockMath>
            </div>
            ...
            <div className="align__center">
                ...
                <BlockMath>{`\\to \\dfrac{w - s}{r} = 1 - \\dfrac{1}{(v + 1 + k)^2}`}</BlockMath>

                <BlockMath>{`\\to 1 - \\dfrac{w - s}{r} = \\dfrac{1}{(v + 1 + k)^2}`}</BlockMath>

                <BlockMath>{`\\to \\dfrac{1}{1 - \\dfrac{w - s}{r}} = (v + 1 + k)^2`}</BlockMath>

                <BlockMath>{`\\to \\dfrac{1}{\\sqrt{1 - \\dfrac{w - s}{r}}} = v + 1 + k`}</BlockMath>

                <BlockMath>{`\\to k = \\dfrac{1}{\\sqrt{1 - \\dfrac{w - s}{r}}} - v - 1`}</BlockMath>

                <p>
                    Sure, let&apos;s substitute the expression we derived for
                    the horizontal shift value k back into the original
                    equation.
                </p>

                <BlockMath>{`R(x, r, s, v, w) = r \\cdot (1 - \\dfrac{1}{(x + 1 + \\dfrac{1}{\\sqrt{1 - \\dfrac{w - s}{r}}} - v - 1)^2}) + s`}</BlockMath>

                <BlockMath>{`\\to R(x, r, s, v, w) = r + s - \\dfrac{r}{(x + \\dfrac{1}{\\sqrt{1 - \\dfrac{w - s}{r}}} - v)^2}`}</BlockMath>

                <BlockMath>{`\\to R(x, r, s, v, w) = r + s - \\dfrac{r}{(x - v + \\dfrac{1}{\\sqrt{\\dfrac{r - w + s}{r}}})^2}`}</BlockMath>

                <BlockMath>{`\\to R(x, r, s, v, w) = r + s - \\dfrac{r}{(x - v + \\sqrt{\\dfrac{r}{r - w + s}})^2}`}</BlockMath>
                ...
                <BlockMath>{`R(x, r, p, v, w) = p - \\dfrac{r}{(x - v + \\sqrt{\\dfrac{r}{p - w}})^2}`}</BlockMath>

                <p>
                    Modified Rydberg formula with vertical and horizontal
                    shifting.
                </p>
            </div>
            ...
            <div className="align__center">
                <BlockMath>{`R^{3.1}_{2S.1/2}(x) = R(x, 13.60676328, 5.39114472, 2, 3.373129)`}</BlockMath>
            </div>

            <div className="align__center">
                <Image src={pic59} alt="The Graphs of Lithium's s Orbital" />
                <p>
            ...
            <div className="align__center">
                <BlockMath>{`k = \\dfrac{1}{\\sqrt{1 - \\dfrac{w - s}{r}}} - v - 1`}</BlockMath>

                <BlockMath>{`\\to k_{s} = \\dfrac{1}{\\sqrt{1 - \\dfrac{20.6157751334 - (24.58556828 - 13.60676328)}{13.60676328}}} - 1 - 1`}</BlockMath>

                <BlockMath>{`\\to k_{s} = −0.148628918071`}</BlockMath>

                <p>
                    If we move all points in the x-axis direction by this
                    amount, they will align with the reference Rydberg formula.
                </p>
            </div>

            <div className="align__center">
                <Image src={pic113} alt="s, p, and d Orbitals" />
                <p>
            ...
            <div className="align__center">
                <BlockMath>{`a = 22.920317682 - 20.6157751334 = 2.3045425486`}</BlockMath>

                <BlockMath>{`b = R(2+k_{s}) - R(1+k_{s}) = 2.29784533694`}</BlockMath>

                <BlockMath>{`a - b = 0.00669721166409`}</BlockMath>

                <BlockMath>{`\\to D(x) = v_2 - v_1 - (R(x+1+k_{2}) - R(x+k_{1}))`}</BlockMath>
            ...
            <div className="align__center">
                <Image src={pic95} alt="Changes in the Helium Orbital Values" />
                <p>
