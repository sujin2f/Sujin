    ...
    useEffect(() => {
        ...
        dispatch(
            setBanner({
                ...
                excerpt: 'Comparison with Another Method',
                icon: undefined,
                prefix: undefined,
    ...
    return (
        <>
            ...
            <div className="align__center">
                <Image src={pic58} alt="s and p Orbital of Helium" />
                <p>
            ...
            <div className="align__center">
                <BlockMath>{`R_{l}(x) = r(\\dfrac{1}{(x + k_{h}) ^ 2}-\\dfrac{1}{(x + k_{h} + 1) ^ 2})`}</BlockMath>
                <p>R(x) with highest k</p>

                <BlockMath>{`R_{h}(x) = r(\\dfrac{1}{(x + k_{l}) ^ 2}-\\dfrac{1}{(x + k_{l} + 1) ^ 2})`}</BlockMath>
                <p>R(x) with lowest k</p>

                <BlockMath>{`R_{h}(x) - R_{l}(x) : 100 = p_{x} - p_{x-1} - R_{l}(x) : v`}</BlockMath>

                <BlockMath>{`\\to v = \\dfrac{100(p_{x} - p_{x-1} - R_{l}(x))}{R_{h}(x) - R_{l}(x)}`}</BlockMath>
            </div>
