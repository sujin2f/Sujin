    ...
    return (
        <>
            ...
            <div className="align__center">
                <BlockMath>{`\\dfrac{1}{\\lambda} = R(\\dfrac{1}{m^2} - \\dfrac{1}{n^2}) \\hspace{10pt} \\{ R=1.0973731568539 \\times 10^7 m^{-1} \\}`}</BlockMath>
                <p>
            ...
            <div className="align__center">
                <BlockMath>{`E = Rhc(\\dfrac{1}{(n - 1)^2} - \\dfrac{1}{n^2})\\cdot6.242\\cdot10^{32}`}</BlockMath>
                <p>
                    Since the Rydberg constant, Planck&apos;s constant, and the
                    speed of light are all constants,
                </p>
                <BlockMath>{`E = 1.0973731568539 \\cdot 10^{-7} \\cdot 6.62607015 \\cdot 10^{-34} \\cdot 299792458 \\cdot (\\dfrac{1}{(n - 1)^2} - \\dfrac{1}{n^2}) \\cdot 6.242 \\cdot 10^{32}`}</BlockMath>
                <BlockMath>{`E = 13.60676328 \\cdot (\\dfrac{1}{(n - 1)^2} - \\dfrac{1}{n^2})`}</BlockMath>
            ...
            <div className="align__center">
                <BlockMath>{`E_n = -\\frac{ℏ^2}{2 \\mu a_0 ^ 2} \\frac{1}{n^2}`}</BlockMath>
            </div>
