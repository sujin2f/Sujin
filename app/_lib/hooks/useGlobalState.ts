...
import { GlobalState } from '@common/model/GlobalState'
 ...
 * }
 */
export const useGlobalState = <T>(key: string, defaultValue: T): [T, Fn<[T]>] => {
    const globalState = GlobalState.getInstance(key, defaultValue) as GlobalState<T>
