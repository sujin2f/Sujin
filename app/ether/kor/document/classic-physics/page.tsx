    ...
    return (
        ...
        >
            <p>
                ...
                <InlineMath>n \geq 4</InlineMath>에서{' '}
                <InlineMath>n = 3</InlineMath>으로 변화하는 파센 계열의 방출
                파장을 정리한 것이다.
            </p>
            ...
            <p>
                ...
                알아보기 힘들다. 4에서 5로 가는 수치가 둘 사이에 차이가 있다는
                이야기이다. 우리는 n 껍질 사이의 공간이 일정한 수치가 되는 것을
                원한다. 가설을 뒷받침하기 위해서는 그것이 동일한 빛-에테르여야
                하기 때문이다. 라이먼 계열의 파장을 그 역수인 파수로 바꾸어
                표현하면 아래와 같다.
            </p>
            ...
            <p>
                ...
                있을 것이다. 빛의 에너지는 <InlineMath>E = hc / λ</InlineMath>의
                식으로 구할 수 있다. 여기서 λ는 앞서 구한 파수를 의미하며,
                이렇게 구한 값은 J의 단위를 가진다. 이를 eV를 단위로 갖는 에너지
                값은 아래의 수식과 같으며, 이를 정리하면 아래의 표와 같다.
            </p>
            ...
            <p>
                ...
                로 치환하고, J를 eV로 변환하면 위에서 구한 값과 일치하는 것을 알
                수 있다.
            </p>
            ...
            <ul>
                ...
                <li>
                    둘째, 광자-에테르가 가진 에너지는 <strong>덧셈</strong>에
                    의해 구할 수 있어야 한다.
                </li>
                <li>
            ...
            <p>
                위 조건을 만족한다면, 광자라는 스파클이 광자-에테르의 형태로
                원자 속에 저장된다는 것을 증명할 수 있을 것이다. 다음 장에서는
                다전자 원자에 대해 다루고자 한다.
            </p>
