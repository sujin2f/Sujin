...
const classNameButton = 'flex items-center justify-center p-0.5 h-9 min-md:pr-2.5 rounded-full'
...
export const Profile = () => {
    ...
    return (
        <>
            {user ? (
                <Button className={classNameButton} onClick={() => logout(pathname)} padding={false}>
                    {user.picture && (
                ...
                <Button className={classNameButton} onClick={() => login(pathname)} padding={false}>
                    <picture className={classNamePicture}>
                        <source
