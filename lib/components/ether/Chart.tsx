...
import { Chart as ChartJS, type ChartDataset, type ChartData as ChartJSData } from 'chart.js/auto'
/* Helpers */
import { getRandomInt } from '@common/utils/number'
import { CHART_COLORS } from '@common/constants/ether'
import { ChartData } from '@common/types' // @todo Name
import { map } from '@common/utils/array'

type Props = { data: ChartData }

const convertChartData = (data: ChartData, term?: string): ChartJSData<'line'> => {
    ...
    const datasets = Object.entries(data)
        ...
        .map(([label, data], index) => {
            return {
                ...
                fill: false,
                borderColor:
                    CHART_COLORS[index] || `rgb(${getRandomInt(256)}, ${getRandomInt(256)}, ${getRandomInt(256)})`,
                tension: 0,
