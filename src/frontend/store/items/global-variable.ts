...
export class GlobalVariable implements GlobalVariableType {
    ...
    private constructor(data: any) {
        this.title = 'Sujin Test Title'
        this.description = 'Sujin Test Description'
        this.url = 'http://localhost:3000/'
        this.thumbnail =
            'https://sujinc.com/wp-content/uploads/2019/09/4-1024x684.jpg'
        this.hideFrontHeader = true
        this.hideFrontFooter = true
        this.frontPage = 'front-page'
        this.showOnFront = 'page'
        this.isProd = false

        const siderail =
            data && data.widgets && data.widgets.siderail
                ? this.getWidgetsArray(data.widgets.siderail)
                : []

        const footer =
            data && data.widgets && data.widgets.footer
