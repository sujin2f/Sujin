...
import { ATTR, CLASS_NAME, TAG_NAME } from 'src/frontend/constants/dom'
    ...
    return (
        <section className="carousel">
            <section className="arrow-nav">
                ...
                <div className="indicator">1/{props.images.length}</div>
...
//         // Nav Images
//         const nav: HTMLCollectionOf<Element> = element.getElementsByTagName(
//             TAG_NAME.NAV,
//         )
//         if (nav.length === 0) {
//             return
...
//         const navItems = (nav.item(0) as Element).getElementsByTagName(
//             TAG_NAME.IMAGE,
//         )
//         this._navItems = Array.from(navItems).map(
//             (navItem) => navItem as HTMLImageElement,
//         )

//         // Frame
//         this._frame = element.querySelector(
//             `.${CLASS_NAME.carousel.PICTURE_FRAME} ${TAG_NAME.IMAGE}`,
//         ) as HTMLImageElement

//         // Buttons
//         this._prev = element
//             .getElementsByClassName(CLASS_NAME.carousel.PREV)
//             .item(0) as HTMLButtonElement
//         this._next = element
//             .getElementsByClassName(CLASS_NAME.carousel.NEXT)
//             .item(0) as HTMLButtonElement

//         this._indicator = element
//             .getElementsByClassName(CLASS_NAME.carousel.INDICATOR)
...
//             ATTR.carousel.SRC,
//             image.getAttribute(ATTR.carousel.SRC) || '',
//         )
