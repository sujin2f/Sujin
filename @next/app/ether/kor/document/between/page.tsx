    ...
    return (
        ...
        >
            <p>
                ...
                적당했을까? 선형이 포함된 변화를 서로 모으면 그들만의 패턴이
                나타나는 것일 수 있지 않을까? 조금 더 객관적인 비교가 필요할 것
            ...
            <p>
                이전 장에서는 원형만 가진 s 오비탈을 한 기준으로 옮기고, 선형을
                가진 나머지를 p 오비탈 쪽으로 이동시켰다. 새롭게 제시할 기준은
                이 두 지점으로 옮긴 그래프를 좌표로 만드는 것이다.{' '}
                <code>[O]</code>로 옮긴 그래프를 0으로, <code>[-]</code>의
                그래프를 100으로 잡았을 때 점의 위치를 표시하는 것이다. 위
                그림에서 가장 위의 보라색 선을 100, 가장 아래의 붉은 점을 0으로
                놓고 그 사이에서 점들이 어떻게 움직이는지 보는 것이다. 이 방식을
                사용하면 모든 점을 한 가지 기준으로 정렬 시킬 수 있을 것이다.
                이것을 Between이라 부르고, 앞서 것을 Transform이라 부르기로
                허자.
            </p>
            ...
            <p>
                ...
                따라서 <InlineMath>{`1-\\dfrac{1}{(x + 1) ^ 2}`}</InlineMath>{' '}
                형태가 아닌{' '}
            ...
            <Row fullWidth>
                <Column medium={6} small={12}>
                    <NextImage
                        ...
                        caption={
                            <>
                                수소 오비탈 <sup>2</sup>S<sub>1/2</sub> 값의
                                Between
                            </>
                        }
                        width={600}
                ...
                <Column medium={6} small={12}>
                    <NextImage
                        ...
                        caption={
                            <>
                                수소 에테르 <sup>2</sup>S<sub>1/2</sub> 값의
                                Between
                            </>
                        }
                        width={600}
            ...
            <Row fullWidth>
                <Column medium={6} small={12}>
                    <NextImage
                        ...
                        caption={
                            <>
                                헬륨 오비탈 <sup>1</sup>S<sub>0</sub> 값의
                                Between
                            </>
                        }
                        width={600}
                ...
                <Column medium={6} small={12}>
                    <NextImage
                        ...
                        caption={
                            <>
                                헬륨 에테르 <sup>1</sup>S<sub>0</sub> 값의
                                Between
                            </>
                        }
                        width={600}
            ...
            <p>
                ...
                오차라고 볼 수 있다. 에테르 변화는 역시 뚜렷하게 나타난다.
                조금더 변화량을 잘 볼 수 있는 높은 번호의 원소를 보자.
            </p>
            ...
            <Row fullWidth>
                <Column medium={6} small={12}>
                    <NextImage
                        ...
                        caption={
                            <>
                                세슘 오비탈 <sup>2</sup>S<sub>1/2</sub> 값의
                                Between
                            </>
                        }
                        width={600}
                ...
                <Column medium={6} small={12}>
                    <NextImage
                        ...
                        caption={
                            <>
                                세슘 에테르 <sup>2</sup>S<sub>1/2</sub> 값의
                                Between
                            </>
                        }
                        width={600}
            ...
            <p>
                ...
                분류법에서는 뚜렷한 패턴을 볼 수 있다. 이것으로 방정식을
                만든다면 p를 예외로 주어야 할 것이다. 세슘과 같은 더 높은 원소로
                가면 d 까지도 예외가 된다.
            </p>

            <p>
                Transform과 Between 모두에서 공통적으로 볼 수 있는 경향이
                존재한다. 뤼드베리 방정식을 이동하는 것으로 꽤 오차가 적은
                예측값을 얻을 수 있다. 그 적은 오차에서도 기존의 오비탈 분류법
                보다는 원형을 우선 배치하는 에테르 분류법이 더 확실한 패턴을 볼
                수 있다는 것이다. 완전한 증거라고 주장하는 것은 아니지만 혹시
                맞을 수도 있지 않을까 하는 가능성을 제시하는 것으로 증명을
                마치도록 하겠다.
            </p>
