...
//     // cacheDirectory: "/private/var/folders/dj/nwpx8rss6t19w3g2vtggwjxc0000gn/T/jest_dx",
...
// const cc = createJestConfig(config)()
...
const config = {
    ...
    moduleNameMapper: {
        ...
        '^@test/(.*)$': '<rootDir>/.jest/$1',
        '^@sujin/lib/(.*)$': '<rootDir>/../@lib/src/$1',
        '^@sujin/share/(.*)$': '<rootDir>/../@common/src/$1',
    },
    setupFiles: ['<rootDir>/.jest/setup.jest.js'],
    testEnvironment: 'jest-environment-jsdom',
    testMatch: [
