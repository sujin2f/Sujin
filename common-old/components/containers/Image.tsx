 ...
 */
const Image = ({ src, alt, width, height, caption, center, sources }: Props) => {
    const className = joinClassNames('image__container', center && 'image__container--center')
    const img = <img alt={alt} className="banner__icon" width={width} height={height} src={src} role="presentation" />
