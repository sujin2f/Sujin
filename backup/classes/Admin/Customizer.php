...
class Customizer {
	...
	private function cusomnize_thumbnails( $wp_customize ) {
		...
		$thumbnails = array(
			...
			'related-post-width'    => array( DefaultValues::RelatedpostWidth, 'Related Post Width' ),
			'related-post-height'   => array( DefaultValues::RelatedpostHeight, 'Related Post Height' ),
